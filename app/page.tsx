...
export const metadata: Metadata = {
  title: "GO eknihovna",
  description: "Gymnazium Opatov eknihovna hlavní stránka",
    ...
    <>
      ...
      <Container maxWidth={"lg"} className="flex flex-col gap-2">
        ...
        <Container>
          ...
          <br />
          <Typography variant="body1">
            Naše knihovna je otevřeným prostorem pro vaše vzdělávání
            a inspiraci. Nabízíme široký výběr literatury, studijních materiálů
            a časopisů.
          </Typography>
          <br />
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            s vyhledáním informací, neváhejte se po vyučovacích hodinách obrátit
            na  profesorku Bauerovou.
          </Typography>
          <br />
          <Typography variant="body1">
        ...
        <Container className="mx-auto mt-2 text-secondary-950  bg-primary-600 p-4 border border-gray-300 rounded-md mb-4">
          <Typography variant="body1">
            Stránku vytvořil Ondřej Lukeš. Děkuji za pomoc všem,
            kteří se podíleli na projektu: Patriku Holbovi, Davidu Laušmanovi,
            prof. Bauerové, Tereze Kryšpínové a redakci Peřinky.
          </Typography>
        </Container>
        <OpeningHours />
        <Box mt={2} display="flex" justifyContent="center">
