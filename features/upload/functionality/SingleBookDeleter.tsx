...
// import React, { useState } from "react";
// import axios from "axios"; // or any other HTTP client of your choice
// import { Button, TextField, Typography, Box, List, ListItemText, Select, MenuItem } from "@mui/material"; // MUI components
...
//     const fetchBook = async (id: string) => {
//       if (!chosenBook) {
//         setError("vyberte knihu pro smazání");
//         return;
//       }
...
//         // Assume fetchFilteredBooks is a function that fetches books based on activeFilters
//         const response = await fetchFilteredBooks(
//           {...defaultFilters, id:chosenBook.id.trim()}, // defaultFilters or appropriate filter object
//           1,
//           10000000,
//           // bookId.trim(),
...
//           <Box sx={{ mt: 2 }}>
//             <Typography variant="body1">
//               Kniha k odstranění: {chosenBook.name}
//             </Typography>
//           <br />
//             <Button
//               variant="contained"
//               color="error"
//               onClick={() => deleteData(chosenBook.id)}
//               disabled={loading}
//             >
//               Smazat knihu
//             </Button>
